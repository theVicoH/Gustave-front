...
>(({ className, asChild = false, active, size = "default", ...props }, ref) => {
  const Comp = asChild ? Slot : "button";
  ...
  return (
    <Comp
      ...
      data-size={size}
      className={cn(
        "relative w-full flex items-center justify-start rounded-lg text-sm font-medium cursor-pointer transition-colors group/button",
        "bg-white text-black",
        "data-[active=true]:bg-black data-[active=true]:text-white",
        "[&_svg]:text-black [&_svg]:data-[active=true]:text-white",
        {
          "p-2": size === "sm",
          "p-3": size === "default",
          "p-4": size === "lg",

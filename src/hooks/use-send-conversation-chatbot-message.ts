...
import { SendChatbotConversationMessageBody, SendChatbotConversationMessageResponse } from "@/types/chatbot";
import { useConversationStore } from "@/stores/chatbot-conversation-store";

const useSendConversationChatbotMessage = (): UseMutationResult<SendChatbotConversationMessageResponse, Error, SendChatbotConversationMessageBody> => {
